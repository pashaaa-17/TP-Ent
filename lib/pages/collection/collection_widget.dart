                ...
                child: Container(
                  ...
                  child: Container(
                    ...
                    child: FutureBuilder<ApiCallResponse>(
                      future: TmdbGroup.popularMoviesCall.call(),
                      builder: (context, snapshot) {
                        ...
                        final columnPopularMoviesResponse = snapshot.data!;
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final movies = TmdbGroup.popularMoviesCall
                                              .id(
                                                columnPopularMoviesResponse
                                                    .jsonBody,
                                              )
                                              ?.map((e) => e)
                                              .toList()
                                              ...
                                              child: Stack(
                                                children: [
                                                  Container(
                                                    ...
                                                    child: Hero(
                                                      tag:
                                                          'http://image.tmdb.org/t/p/w780${TmdbGroup.popularMoviesCall.posterpath(
                                                        columnPopularMoviesResponse
                                                            .jsonBody,
                                                      )?[moviesIndex]}',
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        valueOrDefault<
                                                                          ...
                                                                          TmdbGroup
                                                                              .popularMoviesCall
                                                                              .title(
                                                                            columnPopularMoviesResponse.jsonBody,
                                                                          )?[moviesIndex],
                                                                          'Title',
                                                                        ),
                                                                        maxLines:

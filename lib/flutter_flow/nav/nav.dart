...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'collection',
          path: '/collection',
          builder: (context, params) => CollectionWidget(
            collection: params.getParam(
              'collection',
              ParamType.String,
            ),
          ),
        ...
        FFRoute(
          name: 'ticketPurchase',
          path: '/ticketPurchase',
          builder: (context, params) => const TicketPurchaseWidget(),
        ),
        FFRoute(
          name: 'paymentComplete',
          path: '/paymentComplete',
          builder: (context, params) => const PaymentCompleteWidget(),
        ),
        FFRoute(
          name: 'catalog',
          path: '/catalog',
